...
export async function postDataService<T>(
  axiosInstance: AxiosInstance,
  url: string,
  body: object,
): Promise<T> {
...
export async function deleteDataService<T>(
  axiosInstance: AxiosInstance,
  url: string,
  data: object,
): Promise<T> {
...
export async function putDataService<T>(
  axiosInstance: AxiosInstance,
  url: string,
  data: object,
): Promise<T> {
...
export async function patchDataService<T>(
  axiosInstance: AxiosInstance,
  url: string,
  data: object,
): Promise<T> {
